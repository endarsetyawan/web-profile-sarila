...
<form action="{{route('kamar_dewasa.update', $kamar_dewasa)}}" method="post">
@method('PUT')
 @csrf
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="card-body">        
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" id="nama_bangsal" name="nama_bangsal" value="{{$kamar_dewasa->nama_bangsal}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-email-input" class="col-sm-2 col-form-label text-right">Jumlah Bangsal</label>
                                        <div class="col-sm-10">
                                            <input  class="form-control" type="text" id="jumlah_bangsal" name="jumlah" value="{{$kamar_dewasa->jumlah}}">
                                        </div>
                                    </div>                            
                                </div>
                            </div>     
                            <div class="row">
                                <div class="col-sm-12 text-right">
                                    ...
                                    <a href="{{route('kamar_dewasa.index')}}" class="btn btn-danger">
                                        Batal
                                    </a>
                                </div>
                            </div>                                                                 

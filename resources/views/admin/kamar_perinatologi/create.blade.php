...
<form action="{{route('kamar_perinatologi.store')}}" method="post">
 @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" id="nama_bangsal" name="nama_bangsal">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-email-input" class="col-sm-2 col-form-label text-right">Jumlah Bangsal</label>
                                        <div class="col-sm-10">
                                            <input  class="form-control" type="text" id="jumlah_bangsal" name="jumlah">
                                        </div>
                                    </div>                            
                                </div>
                            </div>     
